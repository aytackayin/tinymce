...
class TinymceServiceProvider extends ServiceProvider
{
    public function boot() {
        ...
        $this->publishes([__DIR__.'/../assets/' => public_path('vendor/aytackayin-tinymce')], 'aytackayin-tinymce-assets');

        $assets = [
            Js::make('tinymce', asset('vendor/aytackayin-tinymce/js/tinymce/tinymce.min.js')),
        ...
        foreach($files as $file) {
            if (str_contains($file, '.js')) {
                ...
                $assets[] = Js::make('tinymce-lang-'.$lang, asset('vendor/aytackayin-tinymce/js/tinymce/langs/'.$file))->loadedOnRequest();
            }
        }
