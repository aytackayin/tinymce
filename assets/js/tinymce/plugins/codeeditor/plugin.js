...
<div id="tox-codeeditor-modal" tabindex="-1">
    <div id="tox-codeeditor-header" role="presentation">
        <div id="tox-codeeditor-modal-title">${windowLable()}</div>
        <button type="button" onclick="displayToxEditorModal(false)" tabindex="-1" id="tox-codeeditor-close-button">
            <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M17.953 7.453L13.422 12l4.531 4.547-1.406 1.406L12 13.422l-4.547 4.531-1.406-1.406L10.578 12 6.047 7.453l1.406-1.406L12 10.578l4.547-4.531z" fill-rule="evenodd"></path></svg>
        </button>
    </div>
    ...
    <div id="tox-codeeditor-footer">
        ...
        <div role="presentation" id="tox-codeeditor-footer-buttons">
            ...
            <button title="Cancel" type="button" tabindex="-1" onclick="displayToxEditorModal(false)" class="tox-codeeditor-secondary-button">${cancelButtonLable()}</button>
            <button title="Save" type="button" tabindex="-1" onclick="saveContent()" class="tox-codeeditor-primary-button">${saveButtonLable()}</button>
        </div>
    </div>
</div>
    `;
